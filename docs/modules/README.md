...
| 模块 | 架构锚点 | 稳定文档位置 | 当前状态 |
| --- | --- | --- | --- |
| Pi 集成 | [`ARCHITECTURE.md` §6.1](../../ARCHITECTURE.md#61-pi-集成模块) | [`pi-integration.md`](pi-integration.md) | 归档与显式召回集成已验证 |
...
| 长时记忆 | [`ARCHITECTURE.md` §6.3](../../ARCHITECTURE.md#63-长时记忆模块) | [`long-term-memory.md`](long-term-memory.md) | 本地来源与完整结果承载已验证 |
