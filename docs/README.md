...
| [`features/context-enhancement-state.md`](features/context-enhancement-state.md) | 增强上下文、Provider 基线、hook 时点证明、current turn、状态和责任边界 |
...
| [`system/context-enhancement.md`](system/context-enhancement.md) | Provider 基线、增强构造、hook 时点证明、ToolBatch、路线和恢复 |
| [`modules/README.md`](modules/README.md) | 架构模块与内部设计映射 |
| [`modules/pi-integration.md`](modules/pi-integration.md) | Pi Provider 基线、记忆投影、hook 观测、命令和状态 |
...
| [`modules/quality-and-cost-observation.md`](modules/quality-and-cost-observation.md) | 复杂长任务、增强采用、责任边界和完整成本 |
...
| [`validation/context-enhancement-state.md`](validation/context-enhancement-state.md) | 复杂长任务、Provider 基线/记忆投影、增强采用和宿主兼容性验证 |
...
| 系统责任、增强采用与宿主边界 | [`ARCHITECTURE.md`](../ARCHITECTURE.md) |
